...
import { TimeCircle, Location } from "react-iconly";
		...
		return (
			<React.Fragment>
				...
				{this.state.restaurant_info &&
					<div className="pl-20 pt-2" style={{ backgroundColor: '#ffffff', display: 'flex', alignItems: 'center', height: '53px', position: 'fixed', top: '-1px', zIndex: '999', width: '100vw' }}>
						<div onClick={() => this.context.router.history.goBack()}>
							<ArrowLeft />
						</div>
						<div className="ml-20">
							<div style={{ fontWeight: 'bolder', fontSize: '14px' }}>{restaurant.name}</div>
							<div style={{ display: 'flex', alignItems: 'center', fontSize: '12px' }}>
								<TimeCircle className="mr-2" size={14} />{" "}
				...
				<div className="col-12 pb-10 pt-10" style={{ position: 'sticky', top: '-50px', zIndex: '999', backgroundColor: '#ffffff' }}>
				...
				<div className={`mt-10`}>
					{!this.state.searching && (
						<div className="px-5">
							...
							{this.props.restaurant_backup_items.recommended && this.props.restaurant_backup_items.recommended.length > 0 && (
								<h3 className="px-10 pt-10 recommended-text">
									Recommended
								</h3>
							)}
					...
					{!this.state.searching && (
						<div className="pl-15 pr-15 pt-5 pb-10 slider-wrapper" id="wrapper" style={{ display: 'flex', alignItems: 'center', overflow: 'scroll', whiteSpace: 'nowrap', position: 'sticky', top: '52px', zIndex: '999', backgroundColor: '#ffffff' }}>
						...
						<div className="ml-20 mr-20">
							<React.Fragment>
								...
								{this.props.restaurant_backup_items.items.map((category, index) =>
									<React.Fragment key={index}>
										<div ref={this[`ref${category.id}`]} style={{ fontWeight: 'bolder', letterSpacing: '1px', color: localStorage.getItem("storeColor"), fontSize: '18px' }} className="mt-20">
											{category.category_name}
										</div>
							...
							<React.Fragment>
								...
								<div className="d-flex align-items-center">
									<img style={{ "height": "30px", "width": "60px", "marginRight": "16px" }} src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_120,h_60/fssai_final_edss9i"} />
									{restaurant.certificate &&
										<div style={{ color: '#93959f', marginTop: '6px' }}>
											License No. {restaurant.certificate}
										</div>
									}
								</div>
								{restaurant.address &&
									<div>
										<hr />
										<div className="d-flex align-items-center">
											<Location style={{ color: '#93959f' }} />
											<div style={{ color: '#93959f', fontWeight: 'bold' }}>
												{restaurant.address}
											</div>
										</div>
									</div>
