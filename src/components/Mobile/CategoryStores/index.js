...
import { ChevronLeft, Search } from "react-iconly";
    ...
    return (
      <React.Fragment>
        ...
        <div className="bg-white">
          ...
          >
            <div className="d-flex align-items-center justify-content-between p-10">
              <div className="d-flex align-items-center">
                ...
                >
                  <ChevronLeft size="medium" style={{}} primaryColor="#000" />
                  {/* <ArrowLeft /> */}
                </div>
                <div>
                  {this.state.category && (
              ...
              >
                <Link to={"/explore"}>
                  <Search size="medium" set={"light"} primaryColor={"#000"} />
                  <Ink duration="500" />
                </Link>
              </div>
            </div>
          ...
          <div className="">
            {this.state.sliders.length === 0 ? null : (
              <div
              ...
              >
                {this.state.sliders.map((restaurant) => (
                  <div className="p-5 d-flex flex-column justify-content-center align-items-center">
                    <DelayLink
                      to={"/slider-stores/" + restaurant.id}
                      key={restaurant.id}
          ...
          <div className="bg-white pb-50" style={{ minHeight: "100vh" }}>
            {this.state.loading ? (
              <ContentLoader
                speed={2}
                width={400}
              ...
              <React.Fragment>
                {this.state.featured_stores.length === 0 &&
                ...
                this.state.closed_stores.length === 0 ? (
                  ...
                  <React.Fragment>
                    <div>
                          ...
                          <LazyLoad>
                            <div className="col-xs-12 col-sm-12 d-flex restaurant-block mb-10">
                              ...
                              >
                                ...
                                <div
                                  style={{ width: "95%" }}
                                  className="block-content ml-4 block-content-full restaurant-info"
                                >
                                  <div
                                    style={{ fontSize: "14px" }}
                                  ...
                                  <div
                                    style={{ fontSize: "10px" }}
                                    className="text-muted truncate-text text-muted"
                                  >
                      ...
                      {this.state.closed_stores.length > 0 && (
                        <div className="mt-20 font-w600 text-muted ml-20 mr-20">
                          CLOSED
                        </div>
                      )}
