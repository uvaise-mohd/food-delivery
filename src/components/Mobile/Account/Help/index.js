                ...
                <div className="bg-white" style={{ minHeight: '100vh' }}>
                    ...
                    <div className="p-15">
                        ...
                        <p>
                            ...
                            <p className="mt-2"><a className="font-weight-bold" href="mailto:help@app.snakyz.com" style={{ color: localStorage.getItem("storeColor") }}>help@snakyz.com</a></p>
                        </p>
                        <hr />
                        ...
                        <p>
                            ...
                            <p className="mt-2"><a className="font-weight-bold" href="tel:+971 50 569 4964" style={{ color: localStorage.getItem("storeColor") }}>+971 50 569 4964</a></p>
                        </p>
                    </div>
                </div>
            </React.Fragment>
