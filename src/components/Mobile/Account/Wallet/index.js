			...
			<React.Fragment>
				<div className="bg-white">
					...
					<div className="block-content block-content-full pt-20 pb-80 height-100-percent px-15">
						<div className="mt-5 font-w600 text-center d-flex align-items-center justify-content-center" style={{ height: '40px', borderRadius: '0.8rem', boxShadow: 'rgb(136 136 136) 0px 0px 10px -3px' }}>
							Wallet Amount:{" "}
