    ...
    if (info) {
      info.then((response) => {
        if (response) {
          ...
          if (
            response.payload.is_active === 1 ||
            response.payload.is_active === 0
          ) {
      ...
      if (nextProps.reviews) {
        nextProps.reviews.forEach((review) => {
          if (review.user_id == this.props.user.data.id) {
            this.setState({
              edited_rating_store: review.rating_store,
              edited_review_store: review.review_store,
    ...
    if (this.state.rating_store === 0) {
      ...
      this.props
        .addRating(
          ...
          this.state.rating_store,
          this.state.review_store
        )
        .then((response) => {
        ...
        {this.state.already_rated && (
          <div className="auth-error mb-50">
            <div className="error-shake">
              The Store has been already rated by you.
            </div>
          </div>
        )}
        ...
        >
                ...
                <Fade bottom>
                  ...
                  >
                    <div className="d-flex justify-content-end">
                      <span onClick={this.handleEditClose}>Close</span>
                    </div>
                    <div>
                      <StarRatingComponent
                        name="edited_rating"
                    ...
                    <div style={{ fontWeight: "bolder", letterSpacing: "1px" }}>
                      Write a Review
                    </div>
                    <div className="text-muted">
                      Share your Experience with this Store here...
                    </div>
                    <textarea
                    ...
                    <div
                      ...
                      className="btn btn-lg btn-continue update-user"
                      style={{
          ...
          >
            <div
              ...
              className="col text-center p-10"
              style={{
                fontWeight: "700",
                color: this.state.menu ? "#ffffff" : "#FF8585",
                backgroundColor: this.state.menu ? "#FF4646" : "#FFBCBC",
                letterSpacing: "1px",
            ...
            <div
              ...
              style={{
                fontWeight: "700",
                color: this.state.review ? "#ffffff" : "#FF8585",
                backgroundColor: this.state.review ? "#FF4646" : "#FFBCBC",
                letterSpacing: "1px",
          ...
          {this.state.menu && !this.state.review && (
            <React.Fragment>
              {this.props.restaurant_info &&
                this.props.restaurant_info.filterdCoupons &&
                this.props.restaurant_info.filterdCoupons.length > 0 && (
                  <div
                    style={{ display: "flex" }}
                    className="slider-wrapper ml-20 mr-20"
                  >
                    {this.props.restaurant_info.filterdCoupons.map(
                      (coupon, index) => (
                        <div
                          className="p-10 mr-20"
                          style={{
                        ...
                        >
                          <div
                            onClick={() => this.handlePopupOpen(coupon)}
                            style={{ display: "flex", alignItems: "center" }}
                          >
                            <img
                            ...
                            />
                            <div
                              className="ml-1 rupees-symbol"
                              style={{ color: "#7E7E7E", fontWeight: "bolder" }}
                            >
                              {coupon.name}
                            </div>
                          </div>
                      ...
                      >
                        ...
                        <div style={{ display: "flex", alignItems: "center" }}>
                          ...
                          {this.props.user.data &&
                            review.user_id == this.props.user.data.id && (
                              <div
                                className="ml-2"
