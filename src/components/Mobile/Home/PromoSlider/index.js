			...
			<React.Fragment>
				...
				>
					{slides.length === 0 ? (
						...
						<Carousel className="mt-20" autoFocus={true} autoPlay={false} showStatus={false} stopOnHover={true} transitionTime={1000} showArrows={false} showThumbs={false}>
							{slides.map(slide => (
