	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.checkout !== this.props.checkout) {
			...
			if (nextProps.checkout.data.order_status_id !== 8 && (nextProps.checkout.data.payment_mode == 'COD' || nextProps.checkout.data.payment_mode == 'WALLET')) {
				...
				setTimeout(() => {
					this.context.router.history.push("/desktop/my-orders");
				}, 5000);
			}
	...
	render() {
		...
		if (this.props.restaurant_info) {
			if (!this.props.restaurant_info.is_active) {
				...
				return <Redirect to={"/desktop/cart"} />;
			}
		}
		...
		return (
			<React.Fragment>
				...
				<Dialog
					...
					PaperProps={{ style: { backgroundColor: "#fff", borderRadius: "10px", marginTop: "2vh" } }}
				>
				...
				{this.state.order_confirm == true && (
					<React.Fragment>
						<div style={{ paddingLeft: '5%', paddingRight: '5%', height: '100%', width: '100%', bottom: '0px', zIndex: '9998', position: 'fixed', backgroundColor: '#000000a6' }}>
							<Fade bottom>
								<div className="bg-white" style={{ height: 'auto', width: '75vw', left: '12.5vw', paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', bottom: '0px', position: 'fixed', zIndex: '9999', borderTopLeftRadius: '2rem', borderTopRightRadius: '2rem' }}>
									...
									<button className="paymentGatewayBlock" onClick={() => this.__placeOrder("", "COD")}
										style={{
											...
											borderRadius: '0.8rem', width: '70vw', border: 'none', height: '40px'
										}}
									>
				...
				{this.state.order_online_confirm == true && (
					<React.Fragment>
						<div style={{ paddingLeft: '5%', paddingRight: '5%', height: '100%', width: '100%', bottom: '0px', zIndex: '9998', position: 'fixed', backgroundColor: '#000000a6' }}>
							<Fade bottom>
								<div className="bg-white" style={{ height: 'auto', left: '0', width: '75vw', left: '12.5vw', paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', bottom: '0px', position: 'fixed', zIndex: '9999', borderTopLeftRadius: '2rem', borderTopRightRadius: '2rem' }}>
											...
											>
												<div>
													<div className="block-content-full clearfix py-3 payment-select-block d-flex align-items-center" style={{ justifyContent: 'space-between' }}>
														<div className="col-10 font-size-h5 font-w600">
															Wallet
															{this.state.walletChecked && (
											...
											>
												<div>
													<div className="block-content-full clearfix py-3 payment-select-block d-flex align-items-center" style={{ justifyContent: 'space-between' }}>
														...
														<div className="col-2 float-right mt-10">
															<img
																src="https://app.snakyz.com/assets/wallet1.png"
																alt={"Wallet"}
																className="img-fluid"
												...
												>
													<div>
														<div className="block-content-full clearfix py-3 payment-select-block d-flex align-items-center" style={{ justifyContent: 'space-between' }}>
															...
															<div className="col-2 float-right mt-10">
																<img
																	src="https://app.snakyz.com/assets/cod.png"
																	alt={gateway.name}
																	className="img-fluid"
																	style={{ height: '4rem', width: '4rem' }}
																/>
