	...
	render() {
		...
		return (
			<React.Fragment>
						...
						<div style={{ paddingLeft: '5%', paddingRight: '5%', height: '100%', width: '100%', bottom: '0px', zIndex: '9998', position: 'fixed', backgroundColor: '#000000a6' }}>
							<Fade bottom>
								<div className="bg-white" style={{ height: 'auto', left: '12.5vw', width: '75vw', paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '100px', bottom: '0px', position: 'fixed', zIndex: '9999', borderTopLeftRadius: '2rem', borderTopRightRadius: '2rem' }}>
									...
									<input onChange={this.handleName} value={this.state.name} style={{ height: '45px', width: '70vw', padding: '10px', paddingLeft: '5vw' }} placeholder="Name" className="mt-2 react-date-picker__wrapper" />

									<div className="font-w600 mt-10">Phone</div>
									<input onChange={this.handlePhone} value={this.state.phone} style={{ height: '45px', width: '70vw', padding: '10px', paddingLeft: '5vw' }} placeholder="Phone" className="mt-2 react-date-picker__wrapper" />

									<div className="font-w600 mt-10">Email</div>
									<input onChange={this.handleEmail} value={this.state.email} style={{ height: '45px', width: '70vw', padding: '10px', paddingLeft: '5vw' }} placeholder="Email" className="mt-2 react-date-picker__wrapper" />
				...
				<div className="bg-white" style={{ marginTop: '2vh', width: '60vw', marginLeft: '15vw' }}>
