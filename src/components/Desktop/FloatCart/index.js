...
class Cart extends Component {
	...
	render() {
		...
		let classes = ["float-cart-desktop"];

		if (!!this.state.isOpen) {
			classes.push("float-cart-desktop--open");
		}
			...
			<React.Fragment>
				{this.state.removeProductFromPreviousRestaurant && (
					<React.Fragment>
						...
						>
							<div className="container" style={{ borderRadius: "5px", height: "220px" }}>
								<React.Fragment>
									...
									<div className="d-flex justify-content-center">
										<div className="text-center mr-4">
											<button
												...
												style={{ borderColor: localStorage.getItem("storeColor"), borderRadius: '2rem' }}
											>
												No
											</button>
										</div>
										...
										<div className="text-center">
											<button
												...
												style={{
													...
													borderColor: localStorage.getItem("storeColor"), color: '#ffffff', borderRadius: '2rem'
												}}
											>
												Yes
											</button>
				...
				>
					{cartProducts.length ? (
						<DelayLink to={"/desktop/cart"} delay={200}>
								...
								<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
									<div style={{ display: 'flex', alignItems: 'center' }}>
										...
										<span className="ml-4" style={{ color: '#FE0B15' }}>
											<span className="rupees-symbol">₹</span> {formatPrice(cartTotal.totalPrice)}
										</span>
									</div>
									<div className="mb-2" style={{ "fontWeight": "900", "color": "white", "backgroundColor": "#FE0B15", "paddingLeft": "20px", "borderRadius": "1.5rem", "paddingRight": "20px", "paddingTop": "10px", "paddingBottom": "10px" }}>
										View Cart
									</div>
								</div>
							</div>
